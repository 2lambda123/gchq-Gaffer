 ...
 * {@link java.util.Comparator}s. Either implement your own comparators or use
 * the
 * {@link uk.gov.gchq.gaffer.data.element.comparison.ElementPropertyComparator}.
 * <p>
 * The provided element comparators will be use sequentially to sort the
 * operation input iterable.
 * </p>
 * <p>
...
@Since("1.0.0")
@Summary("Sorts elements based on provided Comparators and can be used to " +
         "extract the top 'n' elements")
public class Sort implements InputOutput<Iterable<? extends Element>,
                                         Iterable<? extends Element>>,
                             MultiInput<Element>, ElementComparison {

  private Iterable<? extends Element> input;
  @Required private List<Comparator<Element>> comparators;
  ...
  public Sort groups(final String... groups) {
    ...
    if (comparators.isEmpty()) {
      ...
      comparator =
          (ElementPropertyComparator)comparators.get(comparators.size() - 1);
    }
  ...
  @JsonTypeInfo(use = JsonTypeInfo.Id.CLASS, include = JsonTypeInfo.As.PROPERTY,
                property = "class",
                defaultImpl = ElementPropertyComparator.class)
  public List<Comparator<Element>>
  getComparators() {
    return comparators;
  }
  ...
  public static final class Builder extends BaseBuilder<Sort, Builder>
      implements InputOutput.Builder<Sort, Iterable<? extends Element>,
                                     Iterable<? extends Element>, Sort.Builder>,
                 MultiInput.Builder<Sort, Element, Builder> {
    public Builder() { super(new Sort()); }
