 ...
 * seedMatching - can either be {@code SeedMatchingType.RELATED} or {@code
 * SeedMatchingType.EQUAL}. Equal will only return Elements with identifiers
 * that match the seed exactly. Related will return: <ul> <li>Entities when
 * their vertex matches vertex of a EntityId</li> <li>Entities when their vertex
 * matches the source or destination of a EdgeId</li> <li>Edges when their
 * source, destination and directed type matches the EdgeId</li> <li>Edges when
 * their source, destination matches the EdgeId where the DirectedType of the
 * EdgeId is {@code DirectedType.EITHER}</li> <li>Edges when their source or
 * destination match the EntityId's vertex</li>
 * </ul>
 * includeIncomingOutGoing - what type of edges to include
 * <ul>
 * <li>{@code IncludeIncomingOutgoingType.INCOMING} - only returns edges where
 * the destination matches the vertex of EntityId</li> <li>{@code
 * IncludeIncomingOutgoingType.OUTGOING} - only returns edges where the source
 * matches the vertex of EntityId</li> <li>{@code
 * IncludeIncomingOutgoingType.EITHER} - returns all edges regardless of their
 * direction</li>
 * </ul>
 ...
 * <li>{@code DirectedType.EITHER} - return both directed or undirected
 * edges</li>
 * </ul>
 */
...
public class GetElements
    implements InputOutput<Iterable<? extends ElementId>,
                           CloseableIterable<? extends Element>>,
               MultiElementIdInput, SeededGraphFilters, SeedMatching {
  ...
  /**
   * Sets the seedMatchingType which determines how to match seeds to
   * identifiers in the Graph.
   *
   * @param seedMatching a {@link SeedMatchingType} describing how the seeds
   *     should be
   ...
   * Edges/Entities that are 'equal to' or 'related to' seeds are wanted.
   * See filtering documentation
   * Gets the seedMatchingType which determines how to match seeds to
   * identifiers in the Graph.
   */
  @Deprecated
  @Override
  ...
  /**
   * @return seedMatching a {@link SeedMatchingType} describing how the seeds
   *     should be
   * matched to the identifiers in the graph.
   * @see SeedMatchingType
   * @deprecated use a {@link View} instead to specify whether
  ...
  /**
   * Gets the incomingOutGoingType for this operation which is used for
   * filtering Edges.
   *
   * @return includeIncomingOutGoing an {@link IncludeIncomingOutgoingType}
   * that controls the incoming/outgoing direction of {@link
   * uk.gov.gchq.gaffer.data.element.Edge}s that are filtered out in the
   * operation.
  ...
  /**
   * Sets the incomingOutGoingType for this operation which is used for
   * filtering Edges.
   *
  ...
  @Override
  public void
  setIncludeIncomingOutGoing(final IncludeIncomingOutgoingType inOutType) {
    this.includeIncomingOutGoing = inOutType;
  }

  /**
   * Gets the view of this operation which restricts which elements can be
   * retrieved.
   *
  ...
  /**
   * Sets the view of this operation which restricts which elements can be
   * retrieved.
   *
  ...
  /**
   * Gets the flag determining whether to return directed, undirected or both
   * types of edges.
   *
   * @return directedType the {@link DirectedType} which relates to whether the
   *     edges are directed, undirected or
   * either
   * @see DirectedType
   */
  @Override
  ...
  /**
   * Sets the flag determining whether to return directed, undirected or both
   * types of edges.
   *
   * @param directedType the {@link DirectedType} which relates to whether the
   *     edges are directed, undirected or
   *                     either
   * @see DirectedType
   */
  ...
  /**
   * Gets the {@link ElementId}s that are used to filter the elements. These can
   * either be iterable of
   * {@link uk.gov.gchq.gaffer.data.element.id.EdgeId}s or {@link
   * uk.gov.gchq.gaffer.data.element.id.EntityId} or a mix
   *
  ...
  /**
   * Sets the {@link ElementId}s that are used to filter the elements. These can
   * either be iterable of
   * {@link uk.gov.gchq.gaffer.data.element.id.EdgeId}s or {@link
   * uk.gov.gchq.gaffer.data.element.id.EntityId} or a mix
   *
  ...
  /**
   * Get the output type which in this case is {@link CloseableIterable} of
   * {@link Element}s
   *
   ...
   *
   * @param options the operation options. This may contain store specific
   *     options such as authorisation strings or and
   *                other properties required for the operation to be executed.
   * Note these options will probably not be interpreted
   */
  @Override
  ...
  public static class Builder
      extends Operation.BaseBuilder<GetElements, Builder>
      implements InputOutput
                     .Builder<GetElements, Iterable<? extends ElementId>,
    ...
    public Builder() { super(new GetElements()); }
  }
}
