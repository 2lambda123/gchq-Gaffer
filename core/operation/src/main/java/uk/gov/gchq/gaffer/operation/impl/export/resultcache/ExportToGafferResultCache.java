...
public class ExportToGafferResultCache<T> implements ExportTo<T> {
  ...
  public Set<String> getOpAuths() { return opAuths; }

  public void setOpAuths(final Set<String> opAuths) { this.opAuths = opAuths; }
  ...
  public static final class Builder<T>
      extends Operation.BaseBuilder<ExportToGafferResultCache<T>, Builder<T>>
      implements ExportTo.Builder<ExportToGafferResultCache<T>, T, Builder<T>> {
    public Builder() { super(new ExportToGafferResultCache<>()); }
