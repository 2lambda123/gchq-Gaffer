...
public class GetAdjacentIds
    implements InputOutput<Iterable<? extends EntityId>,
                           CloseableIterable<? extends EntityId>>,
               MultiEntityIdInput, SeededGraphFilters {
    ...
    if (null != view && view.hasEntities()) {
      if (view.hasEntityFilters()) {
        throw new IllegalArgumentException(
            "View should not have entities with filters.");
      }
  ...
  @Override
  public TypeReference<CloseableIterable<? extends EntityId>>
  ...
  public static class Builder
      extends Operation.BaseBuilder<GetAdjacentIds, Builder>
      implements InputOutput
                     .Builder<GetAdjacentIds, Iterable<? extends EntityId>,
                              CloseableIterable<? extends EntityId>, Builder>,
                 MultiEntityIdInput.Builder<GetAdjacentIds, Builder>,
                 SeededGraphFilters.Builder<GetAdjacentIds, Builder> {
    public Builder() { super(new GetAdjacentIds()); }
  }
}
