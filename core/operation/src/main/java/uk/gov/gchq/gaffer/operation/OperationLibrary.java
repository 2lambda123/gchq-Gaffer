...
public class OperationLibrary {
  public static OperationChain<Void> chain() { return new OperationChain<>(); }

  public static OpBuilder input(final Object... input) {
    return OpBuilder.input(input);
  }

  public static <T> ToSet<T> deduplicate() { return toSet(); }

  public static <I, O> If<I, O> condition() { return _if(); }

  public static AddNamedOperation
  addNamedOperation(final String operationName,
                    final OperationChain operations) {
  ...
  public static AddNamedView addNamedView(final String name, final View view,
                                          final List<String> writeAccessRoles) {
  ...
  public static AddNamedView addNamedView(final String name, final View view,
                                          final String... writeAccessRoles) {
    return new AddNamedView.Builder()
        .name(name)
        .view(view)
        .writeAccessRoles(Lists.newArrayList(writeAccessRoles))
        .build();
  }
  ...
  public static AddElements addElements() { return new AddElements(); }

  public static AddElementsFromFile addElementsFromFile(
      final String fileName,
      final Class<? extends Function<Iterable<? extends String>,
  ...
  public static AddElementsFromKafka addElementsFromKafka(
      final String topic, final String groupId, final String[] bootstrapServers,
      final Class<? extends Function<Iterable<? extends String>,
                                     Iterable<? extends Element>>>
          elementGenerator) {
  ...
  public static AddElementsFromSocket addElementsFromSocket(
  ...
  public static Sort sort() { return new Sort(); }

  public static ExportToGafferResultCache
  exportToGafferResult(final String key, final Set<String> opAuths) {
  ...
  public static GetExports getExports() { return new GetExports(); }

  public static Aggregate aggregate() { return new Aggregate(); }

  public static Aggregate aggregateEdge(final String group,
                                        final AggregatePair pair) {
    return new Aggregate.Builder().edge(group, pair).build();
  }

  public static Aggregate aggregateEntity(final String group,
                                          final AggregatePair pair) {
    return new Aggregate.Builder().entity(group, pair).build();
  }

  public static Aggregate
  aggregateEdges(final Map<String, AggregatePair> edges) {
    return new Aggregate.Builder().edges(edges).build();
  }

  public static Aggregate
  aggregateEntities(final Map<String, AggregatePair> entities) {
    return new Aggregate.Builder().entities(entities).build();
  }

  public static Filter filterEdge(final String group,
                                  final ElementFilter filter) {
    return filterEdges(new SingletonMap(group, filter));
  }

  public static Filter filterEntity(final String group,
                                    final ElementFilter filter) {
  ...
  filterEntities(final Map<String, ElementFilter> entities) {
  ...
  transformEdges(final Map<String, ElementTransformer> edges) {
    return new Transform.Builder().edges(edges).build();
  }

  public static Transform
  transformEntites(final Map<String, ElementTransformer> entities) {
  ...
  public static GetAllElements getAll() { return getAllElements(); }

  public static GetAllElements getAllElements() { return new GetAllElements(); }
  ...
  public static GetElements get() { return getElements(); }

  public static GetElements getElements() { return new GetElements(); }
  ...
  public static <T> ToArray<T> toArray() { return new ToArray(); }

  public static ToCsv toCsv() { return new ToCsv(); }

  public static ToEntitySeeds toEntitySeeds() { return new ToEntitySeeds(); }

  public static <T> ToList<T> toList() { return new ToList<>(); }

  public static ToMap toMap() { return new ToMap(); }

  public static <T> ToSet<T> toSet() { return new ToSet<>(); }

  public static <T> ToSingletonList<T> toSingletonList() {
    return new ToSingletonList<>();
  }

  public static <T> ToStream<T> toStream() { return new ToStream<>(); }

  public static ToVertices toVertices() { return new ToVertices(); }

  public static <T> Count<T> count() { return new Count<>(); }

  public static CountGroups countGroups() { return new CountGroups(); }

  public static DiscardOutput discardOutput() { return new DiscardOutput(); }

  public static <I, O> ForEach<I, O> forEach() { return new ForEach<>(); }
  ...
  public static GetWalks walk() { return getWalks(); }

  public static GetWalks getWalks() { return new GetWalks(); }

  public static <I, O> If<I, O> _if() { return new If<>(); }

  public static <T> Limit<T> limit(final Integer limit) {
    return new Limit.Builder<T>().resultLimit(limit).build();
  }

  public static <I> uk.gov.gchq.gaffer.operation.impl.Map<I, Object>
  map(final I input) {
    return new uk.gov.gchq.gaffer.operation.impl.Map.Builder<I>()
        .input(input)
        .build();
  }
  ...
  public static ScoreOperationChain
  scoreOperationChain(final OperationChain operationChain) {
  ...
  public static Validate validate() { return new Validate(); }

  public static ValidateOperationChain
  validateOperationChain(final OperationChain operationChain) {
    return new ValidateOperationChain.Builder()
        .operationChain(operationChain)
        .build();
  }

  public static <I, O> While<I, O> repeat() { return _while(); }
  ...
  public static <I, O> While<I, O> _while() { return new While<>(); }
