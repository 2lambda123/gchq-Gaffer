...
/**
 * An {@code AddElements} operation is a {@link
 * uk.gov.gchq.gaffer.operation.Validatable} operation for adding elements. This
 * is a core operation that all stores should be able to handle. This operation
 * requires an {@link Iterable} of {@link
 * uk.gov.gchq.gaffer.data.element.Element}s to be added. Handlers should throw
 * an {@link uk.gov.gchq.gaffer.operation.OperationException} if unsuccessful.
 * For normal operation handlers the operation {@link
 * uk.gov.gchq.gaffer.data.elementdefinition.view.View} will be ignored.
 *
...
public class AddElements implements Validatable, MultiInput<Element> {
  ...
  @JsonTypeInfo(use = JsonTypeInfo.Id.CLASS,
                include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "class")
  @Override
  public Object[]
  createInputArray() {
