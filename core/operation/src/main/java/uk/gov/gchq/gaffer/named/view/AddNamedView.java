...
/**
 * A {@code AddNamedView} is an {@link Operation} for adding a {@link
 * uk.gov.gchq.gaffer.data.elementdefinition.view.NamedView} to a Gaffer graph.
 */
@JsonPropertyOrder(value = {"class", "name", "description", "view"},
                   alphabetic = true)
@Since("1.3.0")
...
public class AddNamedView implements Operation {
  ...
  public void setView(final String view) { this.view = view; }
  ...
  public void setView(final View view) {
    try {
      this.view = null == view ? null
                               : new String(JSONSerialiser.serialise(view),
  ...
  public View getView() {
    try {
      return null == view
          ? null
          : JSONSerialiser.deserialise(view.getBytes(CHARSET_NAME), View.class);
  ...
  public Map<String, ViewParameterDetail> getParameters() { return parameters; }

  public void setOverwriteFlag(final boolean overwriteFlag) {
    this.overwriteFlag = overwriteFlag;
  }

  public boolean isOverwriteFlag() { return overwriteFlag; }
  ...
  public AddNamedView shallowClone() throws CloneFailedException {
    return new AddNamedView.Builder()
        ...
        .writeAccessRoles(
            writeAccessRoles.toArray(new String[writeAccessRoles.size()]))
  ...
  public static class Builder extends BaseBuilder<AddNamedView, Builder> {
    public Builder() { super(new AddNamedView()); }
    ...
    public Builder
    parameters(final Map<String, ViewParameterDetail> parameters) {
